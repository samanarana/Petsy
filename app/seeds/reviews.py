...
def seed_reviews():
    ...
    review2 = Review(userId=2, productId=1, description="Good quality but my cat wasn't interested.", rating=3, dateCreated=datetime(2023, 6, 1))
    review3 = Review(userId=1, productId=2, description="My dog loves this!", rating=5, dateCreated=datetime(2023, 8, 12))
    review4 = Review(userId=3, productId=3, description="Looks great in my aquarium.", rating=4, dateCreated=datetime.now())
    review5 = Review(userId=4, productId=4, description="This broke within a week.", rating=1, dateCreated=datetime(2023, 5, 28))
    review6 = Review(userId=1, productId=3, description="My fish seems more active with this.", rating=4, dateCreated=datetime(2023, 6, 10))
    review7 = Review(userId=1, productId=5, description="A fun toy for my hamster. He seems to enjoy it!", rating=5, dateCreated=datetime(2023, 7, 11))
    ...
    review15 = Review(userId=7, productId=4, description="The unicycle looks sturdy but im is still learning how to use it.", rating=3, dateCreated=datetime(2023, 1, 2))
    ...
    review21 = Review(userId=10, productId=9, description="This scratcher is durable and my cat loves it.", rating=5, dateCreated=datetime(2023, 2 , 10))
