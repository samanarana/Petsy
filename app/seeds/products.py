...
def seed_products():
    ...
    product6 = Product(userId=6, productName='Alligator Rollerblades', description="A set of rollerblades designed for your pet aligator.", price=65.00, category="Travel", quantity=15)
    product7 = Product(userId=2, productName='Alligator Hammock', description="Hammock for your Alligator to lounge on", price=122.99, category="Furniture", quantity=8)
    product8 = Product(userId=4, productName='Normal Dog Bed', description="Just a normal dog bed for dogs with arthritis", price=89.99, category="Furniture", quantity=5)
    product9 = Product(userId=2, productName='Cat Scratch Thing', description="Nice thing for your cat scratch", price=34.99,  category="Furniture", quantity=10)
    product10 = Product(userId=3, productName='Hamster Bedding', description="Soft and absorbent bedding for your hamster's home", price=10.99,  category="Furniture", quantity=6)
    product11 = Product(userId=6, productName='Dog House', description="Classic wooden dog house for your pet's outdoor shelter", price=140.00, category="Furniture", quantity=10)
    product12 = Product(userId=2, productName='Dog Anxiety Wrap', description="A wrap that applies gentle pressure to reduce anxiety in dogs.", price=39.99, category="Wellness", quantity=40)
    product13 = Product(userId=2, productName='Bird Feather Conditioner', description="A conditioner that keeps your bird's feathers shiny and healthy.", price=12.99, category="Wellness", quantity=4)
    product14 = Product(userId=4, productName='Hamster Vitamins', description="Vitamins to supplement your hamster's diet and ensure proper nutrition.", price=8.99, category="Wellness", quantity=7)
    product15 = Product(userId=7, productName='Doggie Sampoo', description="A conditioner that keeps your Dog's hair shiny and healthy.", price=12.99, category="Wellness", quantity=28)
